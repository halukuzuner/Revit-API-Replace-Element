...
public enum RequestId : int
{
	...
	None = 0,
	/// <summary>
	/// "ReplaceSelected" request
	/// Connects selected elements.
	/// </summary>
	ReplaceSelected = 1,
	/// <summary>
	/// "CreateAndConnect" request
	/// Create instance and connect to selected.
	/// </summary>
	CreateAndConnect = 2,
	/// <summary>
	/// "CreateAndConnectAll" request
	/// Create instance and connect to all.
	/// </summary>
	CreateAndConnectAll = 3
};
